...
test.describe('API Endpoints', () => {
  ...
  test('GET /api/products/[id] should return 404 for non-existent product as not found', async ({ request }) => {
  ...
  test('GET /api/products/[id] should return 400 for invalid ID as invalid data', async ({ request }) => {
